...
bright_green="$(color reset green bright)"
bright_blue="$(color reset blue bright)"
bright_red="$(color reset red bright)"
bright_green="$(color reset green bright)"
bright_yellow="$(color reset yellow bright)"
bright_blue="$(color reset blue bright)"
bright_purple="$(color reset magenta bright)"
bright_cyan="$(color reset cyan bright)"
