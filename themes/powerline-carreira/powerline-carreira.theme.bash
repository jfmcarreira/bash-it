...
. "$BASH_IT/themes/powerline-carreira/powerline-carreira.base.bash"
...
CLUSTER_INFO_THEME_PROMPT_COLOR=167

USER_INFO_SSH_CHAR=${POWERLINE_USER_INFO_SSH_CHAR:=" "}
USER_INFO_SSH_CHAR=""

USER_INFO_THEME_PROMPT_COLOR=32
ROOT_INFO_THEME_PROMPT_COLOR=1

USER_INFO_THEME_PROMPT_SUDO_CHAR=${POWERLINE_USER_INFO_THEME_PROMPT_SUDO_CHAR:="↑"}
...
if [[ ${EUID} == 0 ]]
then
  POWERLINE_PROMPT=${POWERLINE_PROMPT:="root_info cwd "}
else
  POWERLINE_PROMPT=${POWERLINE_PROMPT:="battery clock user_info cwd scm python_venv ruby "}
fi
