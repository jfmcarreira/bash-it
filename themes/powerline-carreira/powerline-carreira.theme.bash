...
if [[ ${EUID} == 0 ]]
then
  POWERLINE_LEFT_PROMPT=${POWERLINE_PROMPT:="carreira_root_info cwd "}
else
#   POWERLINE_PROMPT=${POWERLINE_PROMPT:="battery clock carreira_user_info carreira_cwd scm python_venv ruby"}
